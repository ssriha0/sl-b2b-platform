...
//
// LeadCommandResolver provides a level of indirection between jBPM commands and Spring beans
...
//
public class LeadCommandResolver implements ApplicationContextAware {
    ...
    public ILeadCommand resolve(String commandName, Map<String,Object> processVariables) {
	...
	private ILeadCommand createCommand(String commandName) {
		ILeadCommand command = (ILeadCommand)context.getBean(commandName);
		command.setLeadDao(leadDao);
		return command;
	}
