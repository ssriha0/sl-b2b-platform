...
public class InHomeNPSConstants {
    ...
    public static final String RESCHEDULE_MESSAGE ="Service order has been rescheduled ";
    ...
    public static final String EMAIL_CONTENT = "ServiceLive is unable to update NPS for the following SO Ids.";
    public static final String MAIL_HOST="smtp.sears.com";
    public static final String NPS_NOTIFICATION_SUBJECT_INHOME = "SL-NPS Integration Failure Notification for InHome";
	...
	public static HashMap<String, String> coverageCodes(){
		...
		coverageCodes.put(PROTECTION_AGREEMENT, PA);
	...
	public static final int RELEASE_INDICATOR = 1;
	...
	public static final Integer STATUS_DRAFT = 100;
	...
	//priority 4 changes
	public static final String NO_MATCHING_RULE = "NoMatchingRule";
