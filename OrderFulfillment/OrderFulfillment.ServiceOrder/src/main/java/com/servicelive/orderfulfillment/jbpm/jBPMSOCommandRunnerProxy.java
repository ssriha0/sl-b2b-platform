...
import com.servicelive.orderfulfillment.command.util.SOCommandRunner;
...
// - list of SOCommands to invoke: a list of semi-colon separated command names
//
...
//
public class jBPMSOCommandRunnerProxy implements EventListener 
{
	...
	public void notify(EventListenerExecution execution) throws Exception 
	{
		...
		{		
			...
			logger.debug("calling soCommandRunner");
			...
			SOCommandRunner cmdRunner = SOCommandRunner.getRunnerInstance();
