...
public class PropertyUtil {
	private static final String SL_TOKENIZATION_QUERY_NAME = "tokenizationqueries.properties";
    private static final String SL_TOKENIZATION_CONSTANTS_NAME = "tokenizationconstants.properties";
