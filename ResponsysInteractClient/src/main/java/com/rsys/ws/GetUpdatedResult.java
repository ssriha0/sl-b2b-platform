                        ...
                        */
                           ...
                           */
                           public  long[] getId(){
                               ...
                               */
                              protected void validateId(long[] param){
                           ...
                           xmlWriter);
                             ...
                             if (localId!=null) {
                                   ...
                                   for (int i = 0;i < localId.length;i++){
                                                   ...
                                                   if (localId[i]!=java.lang.Long.MIN_VALUE) {
                                  ...
                                  for (int i = 0;i < localId.length;i++){
                                    ...
                                    elementList.add(null);
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("urn:ws.rsys.com",
                                         ...
                                         elementList.add(localLatestDateCovered==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localLatestDateCovered));
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetUpdatedResult".equals(type)){
                                ...
                                return (GetUpdatedResult)com.rsys.ws.fault.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("urn:ws.rsys.com","id").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:ws.rsys.com","latestDateCovered").equals(reader.getName())){
