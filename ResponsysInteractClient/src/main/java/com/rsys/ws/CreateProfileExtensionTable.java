...
/**
 * CreateProfileExtensionTable.java
 *
 ...
 */
            ...
            /**
            *  CreateProfileExtensionTable bean class
            */
        
        public  class CreateProfileExtensionTable
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       CreateProfileExtensionTable.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":createProfileExtensionTable",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "createProfileExtensionTable",
                           xmlWriter);
                                            ...
                                            if (localProfileExtension==null){
                                                 throw new org.apache.axis2.databinding.ADBException("profileExtension cannot be null!!");
                                            }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("urn:ws.rsys.com",
                                    ...
                                    elementList.add(localProfileExtension);
    ...
    public static class Factory{
        ...
        */
        public static CreateProfileExtensionTable parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CreateProfileExtensionTable object =
                new CreateProfileExtensionTable();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"createProfileExtensionTable".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CreateProfileExtensionTable)com.rsys.ws.fault.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
