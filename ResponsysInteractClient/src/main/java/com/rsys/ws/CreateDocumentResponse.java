 ...
 */
            ...
            /**
            *  CreateDocumentResponse bean class
            */
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":createDocumentResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "createDocumentResponse",
    ...
    public static class Factory{
        ...
        */
        public static CreateDocumentResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CreateDocumentResponse object =
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"createDocumentResponse".equals(type)){
                                ...
                                return (CreateDocumentResponse)com.rsys.ws.fault.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
