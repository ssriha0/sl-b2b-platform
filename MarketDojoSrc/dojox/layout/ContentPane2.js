dojo.provide("dojox.layout.ContentPane2");
	...
	dijit._Widget,
{
	...
	errorMessage: "<span id='err' class='dijitContentPaneError'>${errorState}</span>", // TODO: consider a graphical representation for this state which does not require localization
	...
	_downloadExternalContent: function(){
		...
		hand.addCallback(function(html){
			try{
				//free tab fix
				if(typeof _actvController == "undefined"){
				}
				else {
					_actvController.allow_free_tabbing=true;//free tab fix
				}
