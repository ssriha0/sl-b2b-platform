...
dojo.declare(
	...
	[dijit._Widget, dijit._Templated, dijit._Container],
	{
		...
		onAddChild: function(/*Widget*/ page){
			...
			//dojo.connect(button, "onClick", function(){_commonSOMgr.setSelectedWidget(page.id); });
		...
		onButtonClick: function(/*Widget*/ page){
			...
			if(typeof _actvController == "undefined"){
				...
				if(_actvController.allow_free_tabbing){
					container.selectChild(page);
				}else{
				}
			}
			...
			if(typeof _commonSOMgr == "undefined"){
				...
				_commonSOMgr.setSelectedWidget(page.id);
			}
		},
