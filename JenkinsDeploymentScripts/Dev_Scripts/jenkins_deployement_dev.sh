...
source $1/JenkinsDeployementScripts/Dev_Scripts/jenkins_deployement_dev.config
source $1/JenkinsDeployementScripts/Dev_Scripts/revert_failed_build_dbscripts_dev.sh
...
undeploy_war() {
	...
	deploy_war "" $all_api_hosts $all_deployables_api $all_script_callback $all_callback_war_name $jenkins_path_callback $log_file_path_api
	...
	deploy_war "" $all_batch_hosts $all_deployables_batch $all_script_spn $all_sl_spn_batch_war_name $all_script_spn_batch $log_file_path_batch
	...
	deploy_war "" $all_marketfrontend_hosts $all_deployables_marketfrontend $all_script_ServiceLiveWebUtil $all_sl_ServiceliveWebUtil_war_name $jenkins_path_MarketFrontend $log_file_path_frontend
	## Starting deployment of spn war
	deploy_war "" $all_marketfrontend_hosts $all_deployables_marketfrontend $all_script_spn $all_sl_spn_war_name $jenkins_path_MarketFrontend $log_file_path_frontend
