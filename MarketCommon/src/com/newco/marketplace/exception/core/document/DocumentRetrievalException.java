...
/*
 * Maintenance History
 * $Log: DocumentRetrievalException.java,v $
 ...
 *
 */
public class DocumentRetrievalException extends DataServiceException {
	...
	public DocumentRetrievalException(String message, Exception cause) {
		super(message, cause);
	}
