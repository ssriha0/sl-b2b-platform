...
/*
 * Maintenance History
 * $Log: DocumentDeleteException.java,v $
 ...
 *
 */
public class DocumentDeleteException extends DataServiceException {
	...
	public DocumentDeleteException(String message, Exception cause) {
		super(message, cause);
	}
