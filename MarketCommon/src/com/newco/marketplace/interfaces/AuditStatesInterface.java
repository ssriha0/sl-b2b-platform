...
public interface AuditStatesInterface {
    ...
    public final String RESOURCE_PICTURE = "Team Member Picture";
    ...
    public final String TEN_DAY_EXCEPTION = "10 Day Exception";
    public final String ENDORSEMENT = "Endorsement";
    public final String CANCELLATION_NOTICE = "Cancellation Notice";
    ...
    public final int COMPANY_AUDIT_LINK_ID = 3;
    public final int PROVIDER_AUDIT_LINK_ID = 4;
