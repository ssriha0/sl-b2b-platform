...
<!-- $Header: /cvsroot/pmd/pmd/etc/xslt/wz-pmd-report.xslt,v 1.1 2005/06/28 13:51:49 tomcopeland Exp $ -->
...
<body>
  ...
  <xsl:for-each select="file">
      ...
      <td style="padding: 3px" align="left">
        <xsl:value-of disable-output-escaping="yes" select="substring-before(translate(../@name,'/','.'),'.java')"/>
      </td>
