...
set GROOVY_HOME=%DIRNAME%\..\ant\opt\groovy
...
if exist %GROOVY_HOME%\groovy-all-1.6.3.jar set STARTER_CLASSPATH=%GROOVY_HOME%\groovy-all-1.6.3.jar
if exist %GROOVY_HOME%\lib\groovy-1.6.3.jar set STARTER_CLASSPATH=%GROOVY_HOME%\lib\groovy-1.6.3.jar
