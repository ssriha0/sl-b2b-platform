package com.newco.marketplace.api.provider.utils.convertors;
...
DateConvertor.toString(new Date())         
"2012-07-03T11:54:24.256 UTC"

// Legacy format, specific date
DateConvertor.toLegacyString(new Date())   
"Tue Jul 03 11:54:24 UTC 2012"

// ISO, specific date and time zone
DateConvertor.toString(moonLandingDate, "yyyy-MM-dd hh:mm:ss zzz", "CST") 
"1969-08-20 03:17:40 CDT"

// Specific format and date
DateConvertor.toString(moonLandingDate, "yyyy-MM-dd")
"1969-08-20"

// ISO, specific date
DateConvertor.toString(moonLandingDate)
"1969-08-20T20:17:40.234 UTC"

// Legacy, specific date
DateConvertor.toLegacyString(moonLandingDate)
...
public class DateConvertor {
    ...
    public static String now() {
        return DateConvertor.toString(new Date());
    }
     ...
     * System.out.println("UTCDate.toString moon:       " + DateConvertor.toString(moonLandingDate));
