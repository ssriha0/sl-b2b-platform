...
$ctaBtn1 = '<a role="button" href="#" class="btn btn-default full" data-toggle="modal" data-target="#completeWidget">Complete Order</a>';
//$ctaBtn2 = '<a role="button" href="#" class="btn btn-default">Update Status</a>';
...
$reScheduleLink = '<a href="#" data-toggle="modal" data-target="#scheduleWidget">Update Appt.</a>';
$assignedPro = '1';
