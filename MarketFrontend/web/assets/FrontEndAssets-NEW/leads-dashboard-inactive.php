          ...
          <ul class="list-group list">
              ...
              <li class="list-group-item" data-leadid="12345">
                  <div class="row">
                      ...
                      <div class="col-xs-11 col-md-4">
                        <h2>
                          <span class="name">Bob Loblaw</span> <small class="leadid">Service Request #11111</small>
                        </h2> 
                        <div class="lead-info">
              ...
              <li class="list-group-item" data-leadid="12345">
                  <div class="row">
                      ...
                      <div class="col-xs-11 col-md-4">
                        <h2>
                          <span class="name">Tobias Funke</span> <small class="leadid">Service Request #11111</small>
                        </h2> 
                        <div class="lead-info">
              ...
              <li class="list-group-item" data-leadid="12345">
                  <div class="row">
                      ...
                      <div class="col-xs-11 col-md-4">
                        <h2>
                          <span class="name">Michael Bluth</span> <small class="leadid">Service Request #11111</small>
                        </h2> 
                        <div class="lead-info">
              ...
              <li class="list-group-item" data-leadid="12345">
                  <div class="row">
                      ...
                      <div class="col-xs-11 col-md-4">
                        <h2>
                          <span class="name">Maggie Lizer</span> <small class="leadid">Service Request #11111</small>
                        </h2> 
                        <div class="lead-info">
              ...
              <li class="list-group-item" data-leadid="12345">
                  <div class="row">
                      ...
                      <div class="col-xs-11 col-md-4">
                        <h2>
                          <span class="name">Lucille Bluth</span> <small class="leadid">Service Request #11111</small>
                        </h2> 
                        <div class="lead-info">
