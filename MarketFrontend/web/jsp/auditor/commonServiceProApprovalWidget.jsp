...
<c:if test="${requestScope.showAdminWidget != null }">
		...
		<div dojoType="dijit.TitlePane" title="Service Pro Approval"
				...
				<tr>
					<td width="231">
						...
						<div id="currentStatus">
							<b> ${requestScope.current_service_pro_status != null ?
								requestScope.current_service_pro_status : 'N/A'}</b>
						</div>
					</td>
				</tr>
				<tr>
					<td>
						<label>
							<s:select cssStyle="width: 200px;" id="commonSEL1"
								...
								list="#application.audit_team_selects" listKey="type"
								listValue="descr" multiple="false" size="1" theme="simple"
								onchange="newco.jsutils.handleCommonAJAXCall(this,'commonSEL1','Team Member','innerT','ServiceProCompany')" />
						</label>
					</td>
				</tr>
			</table>
						...
						<input type="hidden" id="ss" name="ss" value="${securityToken}"/>
							<label>
								<input type="button" name="Button" value="Save Provider Status"
									onclick="newco.jsutils.handleServiceProAppv('commonSEL1','Team Member')" />
							</label>
						</td>
					</tr>
				</table>
