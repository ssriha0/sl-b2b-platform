...
<html>
	<head>
		<title>[Response Status]</title><link rel="shortcut icon" href="${staticContextPath}/images/favicon.ico" />
	...
	<body class="tundra">
		...
		<jsp:include page="/jsp/public/common/omitInclude.jsp" flush="true">
			 <jsp:param name="PageName" value="SOD - Response Status"/>
		</jsp:include>	
	
		<div id="page_margins">
			<div id="page">
				<div dojoType="dijit.layout.ContentPane" href="html_sections/header/hdr_provider.html" style="overflow: visible;">
				</div>
				<div id="mainTabContainer" dojoType="dijit.layout.TabContainer"
					style="height: 600px;width: 975px;" class="detailsTabs">
					<div id="Summary" dojoType="dijit.layout.ContentPane" title="Summary" href="">
					</div>
					<div id="" dojoType="dijit.layout.ContentPane" title="Response Status" selected="true" href="html_sections/modules/tab_response_status.html">
					</div>
