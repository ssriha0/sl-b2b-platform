...
<html>
	<head>
		<title>[Buyer Completion]</title><link rel="shortcut icon" href="${staticContextPath}/images/favicon.ico" />
	...
	<body class="tundra">
		...
		<jsp:include page="/jsp/public/common/omitInclude.jsp" flush="true">
			 <jsp:param name="PageName" value="SOD - Completion Doc"/>
		</jsp:include>	
			...
			<div id="page">
				...
				<div id="mainTabContainer" dojoType="dijit.layout.TabContainer"
                    ...
                    <div dojoType="dijit.layout.ContentPane"
						title="Close & Pay" selected="true"
						href="html_sections/modules/tab_buyer_comp_doc.html">
					</div>
                    
					<div dojoType="dijit.layout.ContentPane"
						title="Response History"
                        href="html_sections/modules/tab_response_history.html">
					</div>
