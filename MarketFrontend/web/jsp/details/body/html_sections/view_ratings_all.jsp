		...
		<div id="page_margins">
			<div id="page">
				...
				<div id="mainTabContainer" dojoType="dijit.layout.TabContainer"
					style="height: 1200px;width: 975px;" class="detailsTabs">
					<div id="Summary" dojoType="dijit.layout.ContentPane" title="Summary" href="">
					</div>
					<div id="" dojoType="dijit.layout.ContentPane" title="View Ratings" selected="true" href="html_sections/modules/tab_view_ratings.html">
					</div>
