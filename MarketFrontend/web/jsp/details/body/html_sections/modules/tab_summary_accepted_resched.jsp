...
<c:set var="staticContextPath" scope="request" value="<%=request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+"/ServiceLiveWebUtil"%>" />
            ...
            <jsp:include page="/jsp/public/common/omitInclude.jsp" flush="true">
                  <jsp:param name="PageName" value="ServiceOrderDetails.summaryAcceptedResched"/>
            </jsp:include>
...
<div class="contentPane">
	<div dojoType="dijit.TitlePane" title="Service Order Details"
		...
		<table cellpadding="0" cellspacing="0" class="noMargin">
			<tr>
				<td width="300">
					<p><img src="${staticContextPath}/images/so_wizard/block150.gif" alt="image" title="Placeholder" />	</p>
					...
					<table cellpadding="0" cellspacing="0" class="adjustedTableRowPadding">
						...
						<tr>
							<td>
								...
								<b>Requested Reschedule Date(s)</b>

							</td>
							<td width="15px"></td>
							<td align="left">

								June 28, 2007 - July 7, 2007
						...
						<tr>
							...
							<td align="left">
								...
								<p>
									...
									<input type="image" src="${staticContextPath}/images/common/spacer.gif"
										width="105" height="20"
										style="background-image: url(${staticContextPath}/images/btn/cancelRequest.gif);"
										class="btn20Bevel inlineBtn" />
								</p>
							</td>
						</tr>
