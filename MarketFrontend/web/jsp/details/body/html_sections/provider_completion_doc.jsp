...
<html>
	<head>
		<title>SOD: Provider Completion Document</title><link rel="shortcut icon" href="${staticContextPath}/images/favicon.ico" />
	...
	<body class="tundra">
		...
		<jsp:include page="/jsp/public/common/omitInclude.jsp" flush="true">
			 <jsp:param name="PageName" value="SOD - Provider Completion Doc"/>
		</jsp:include>	
			...
			<div id="page">
				...
				<div id="mainTabContainer" dojoType="dijit.layout.TabContainer"
					...
					<div id="Summary" dojoType="dijit.layout.ContentPane"
						title="Summary" selected="false" href="html_sections/modules/tab_summary_posted_sent.html">
					</div>
					
					<div dojoType="dijit.layout.ContentPane"
						title="Time on Site" selected="false"
                    ...
                    <div dojoType="dijit.layout.ContentPane"
						title="Complete for Payment" selected="true"
						href="html_sections/modules/tab_prov_comp_docs.html">
					</div>
