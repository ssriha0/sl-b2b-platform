...
@import "${staticContextPath}/javascript/dojo/dijit/themes/tundra/tundra_rtl.css";
		...
		<link rel="stylesheet" type="text/css"
			href="../../css/dijitCalendar-serviceLive.css">
		<link rel="stylesheet" type="text/css"
			href="../../css/service_order_wizard.css" />
	</head>
	<body class="tundra">
		<div align="center">
			<div class="serviceOrderAcceptFrame">
				<div class="serviceOrderAcceptHdr">
					<a href="#"><img src="${staticContextPath}/images/so_details/checkmark.gif"
							border="0" align="left"> </a><a href="#"><img
							src="${staticContextPath}/images/so_details/info_blue_bar.gif" border="0"
							align="right"> </a>
				</div>
				<div class="serviceOrderAcceptFrameBody">
					<p>
						Please verify your acceptance of the buyer's Terms & Conditions as
						well as ServiceLive's Terms & Conditions.
					</p>
...
Nulla tortor nunc, malesuada non, posuere dignissim, hendrerit non, elit. Aenean bibendum urna in augue. Fusce tellus. Duis lacinia urna sit amet nulla. Fusce convallis, neque quis sodales convallis, urna nisl hendrerit orci, sit amet volutpat turpis neque sed est. Pellentesque viverra ullamcorper massa. Fusce egestas molestie nulla. Praesent congue consectetuer ante. Sed luctus venenatis turpis. Sed nonummy imperdiet arcu. Donec scelerisque. Suspendisse in neque eget sem ullamcorper fermentum. Vestibulum ut justo. Suspendisse consectetuer nunc sit amet ipsum. Duis non pede quis nunc scelerisque viverra. Mauris ut erat at ipsum consectetuer sagittis. Aliquam mattis odio sed odio. Nam metus dui, semper vel, euismod nec, condimentum ut, diam.
					...
					<br />
					<p>
						<input type="checkbox" class="shadowbox" />
						<b>I accept these Terms &amp; Conditions</b>
					</p>
					<br />
					<p>
						<a href="#"><img src="${staticContextPath}/images/common/spacer.gif"
								width="72" height="22"
								style="background-image: url(${staticContextPath}/images/btn/accept.gif);"
								class="btnBevel" align="left" /> </a><a href="#"><img
								src="${staticContextPath}/images/common/spacer.gif" width="55" height="22"
								style="background-image: url(${staticContextPath}/images/btn/cancel.gif);"
								class="btnBevel" align="right" /> </a>
					</p>
				</div>
			</div>
			...
			<div class="rejectServiceOrderFrame">
				...
				<div class="rejectServiceOrderFrameBody">
					<p>
						...
						it to be re-routed to other providers. Doing so violates the
						agreement you've made with your buyer and may have a negative
						impact on your overall provider reputation. You must select a
						reason code and add comments to release the order.
					</p>
					<b>Reason Code</b>
					<br />
					<br />
					...
					<input type="image" src="${staticContextPath}/images/common/spacer.gif" width="72"
						height="22"
						style="background-image: url(${staticContextPath}/images/btn/accept.gif); float: left;"
						class="btnBevel" />
					<input type="image" src="${staticContextPath}/images/common/spacer.gif" width="55"
						height="22"
				...
				<div class="acceptWithConditionsFrameBody">
					...
					<table cellpadding="0px" cellspacing="0px">
						<tr>
							...
							<td width="10px"></td>
							<td>
								<input type="radio" name="dateSpecStepTwo" />
							</td>
							<td width="2px"></td>
							<td>
								Specific
							...
							<td width="10px"></td>
							<td>
								<input type="radio" name="dateSpecStepTwo" CHECKED />
							</td>
							<td width="2px"></td>
							<td>
								Range
						...
						<tr>
							<td>
								<input type="text" class="shadowBox"
									...
									onFocus="popUp(event,'calendar')"
									onBlur="popUp(event,'calendar')" />
							</td>
							<td>
								&nbsp;to&nbsp;
							</td>
			...
			<div id="calendar"
				style="visibility: hidden; z-index: 100; position: absolute; left: 0px; top: 0px;"
				onClick="popUp(event,'calendar')">
