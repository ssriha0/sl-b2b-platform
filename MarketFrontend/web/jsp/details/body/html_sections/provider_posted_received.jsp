...
<html>
	...
	<body class="tundra">
		...
		<jsp:include page="/jsp/public/common/omitInclude.jsp" flush="true">
			 <jsp:param name="PageName" value="SOD - Provider Posted Received"/>
		</jsp:include>	
	
		<div id="page_margins">
			<div id="page">
				<div dojoType="dijit.layout.ContentPane"
					href="html_sections/header/hdr_provider.html" style="overflow:visible;">
				</div>
				<div id="mainTabContainer" dojoType="dijit.layout.TabContainer"
					style="height: 3600px;width: 975px;" class="detailsTabs serviceOrderTabPaneTall">
					<div id="Summary" dojoType="dijit.layout.ContentPane"
						title="Summary" selected="true" href="html_sections/modules/tab_summary_prov_posted_recd.html">
					</div>
