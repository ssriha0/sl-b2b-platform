...
<html>
	...
	<body class="tundra">
		...
		<jsp:include page="/jsp/public/common/omitInclude.jsp" flush="true">
			 <jsp:param name="PageName" value="SOD - Provider Rate Buyer"/>
		</jsp:include>	
		...
		<div id="page_margins">
			<div id="page">
				...
				<div id="mainTabContainer" dojoType="dijit.layout.TabContainer"
					...
					<div id="Summary" dojoType="dijit.layout.ContentPane" title="Summary" selected="false" href="html_sections/modules/tab_summary.html">
					</div>
					...
					<div id="Rate Provider" dojoType="dijit.layout.ContentPane"
						...
						href="html_sections/modules/tab_rate_buyer.html">
					</div>
					<div id="Response History" dojoType="dijit.layout.ContentPane"
						title="Response History" selected="false"
						href="">
					</div>
