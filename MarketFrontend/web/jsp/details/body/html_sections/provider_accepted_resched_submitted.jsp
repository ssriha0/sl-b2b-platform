...
<html>
	<head>
		<title>[Provider Service Order Details - Accepted / Reschedule Request Submitted]</title><link rel="shortcut icon" href="${staticContextPath}/images/favicon.ico" />
...
<script language="JavaScript" type="text/javascript" src="../../js/formfields.js"></script>
		...
		<link rel="stylesheet" type="text/css" href="../../css/tooltips.css" /><link rel="stylesheet" type="text/css" href="../../css/so_details.css">
	...
	<body class="tundra">
		...
		<jsp:include page="/jsp/public/common/omitInclude.jsp" flush="true">
			 <jsp:param name="PageName" value="SOD - Provider Accepted Reschedule Submitted"/>
		</jsp:include>	
	
		<div id="page_margins">
			<div id="page">
				<div dojoType="dijit.layout.ContentPane"
						title="header" href="html_sections/header/hdr_provider.html" style="overflow:visible;">
				</div>
				<div id="mainTabContainer" dojoType="dijit.layout.TabContainer"
					style="height: 4200px; width: 975px;" class="detailsTabs">
					<div id="Summary" dojoType="dijit.layout.ContentPane" xstyle="margin: 5px 5px 5px 5px;"
						title="Summary" selected="true" href="html_sections/modules/tab_summary_accepted_resched.html">
					</div>
                    <div dojoType="dijit.layout.ContentPane"
