...
<div>
<select id ="docCategoryId" name ="docCategoryId">
<option	selected="selected" value='-1'/>-Select One-</option>
<option	value='9'/>Signed Customer Copy Including Waiver of Lien</option>
<option	value='10'/>Proof of Permit</option>
...
<div id='doc_upload_file_sel_div'>
	...
	<input type="button" id="attachDocumentBtn"
		onclick="savePermitWarningStatus();validateFileName('document.upload', 'documentUpload')"
		class="btn20Bevel"
