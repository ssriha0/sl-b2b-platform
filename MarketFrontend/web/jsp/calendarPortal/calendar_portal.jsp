...
<body class="tundra acquity">
	<div id="page_margins">
		<div id="page">
			...
			<!-- start main content -->
			<div>
				<link rel="stylesheet" type="text/css" href="${staticContextPath}/calendar/dist/app.css" />
					<my-app>Loading...</my-app>
				<script type="text/javascript" src="${staticContextPath}/calendar/dist/polyfills.js"></script>
				<script type="text/javascript" src="${staticContextPath}/calendar/dist/vendor.js"></script>
				<script type="text/javascript" src="${staticContextPath}/calendar/dist/app.js"></script>
			</div>
			<!-- end main content -->
