...
<html>
	<head>
		<title>[Posted / Sent]</title><link rel="shortcut icon" href="${staticContextPath}/images/favicon.ico" />
		...
		<div id="page_margins">
			<div id="page">
				<div dojoType="dijit.layout.ContentPane"
						title="header" href="html_sections/header/hdr_buyer.html" style="overflow:visible;">
				</div>
				<div id="mainTabContainer" dojoType="dijit.layout.TabContainer"
					...
					<div id="Summary" dojoType="dijit.layout.ContentPane" xstyle="margin: 5px 5px 5px 5px;"
						title="Summary" selected="true" href="html_sections/modules/tab_summary_posted_sent.html">
					</div>
					
					<div dojoType="dijit.layout.ContentPane"
						title="Response Status" href="soDetailsResponseStatus">
					</div>
                    <div dojoType="dijit.layout.ContentPane"
						title="Notes"
