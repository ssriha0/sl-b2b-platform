...
<html>
	<head>
		<title>[Report A Problem]</title><link rel="shortcut icon" href="${staticContextPath}/images/favicon.ico" />
	...
	<c:choose>
		...
		<div id="page_margins">
			<div id="page">
				<div id="header" dojoType="dijit.layout.ContentPane" title="header" href="html_sections/header/hdr_buyer.html">
				</div>
				<div id="mainTabContainer" dojoType="dijit.layout.TabContainer" style="height: 4000px; width: 975px;" class="detailsTabs">
					<div id="Summary" dojoType="dijit.layout.ContentPane" title="Summary" href="html_sections/modules/tab_summary_posted_sent.html">
					</div>
                    <div dojoType="dijit.layout.ContentPane" title="Report a Problem" selected="true" href="html_sections/modules/tab_report_a_problem.html">
					</div>
				</div>
				<!-- END TAB PANE -->
				<div class="clear"></div>
