...
<div class="leftTileItem" id="dbTile_profilePrefs">
    	...
    	<div class="titleBar">
      	<img src="${staticContextPath}/images/dashboard/hdrReports.gif" width="37" height="23" align="left" class="titleImage" />
        <a href=""><img src="${staticContextPath}/images/dashboard/lnkMore.gif" width="41" height="23" border="0" align="right" /></a>
    	</div>
    </div>
    <div class="contentContainer">
    	<div class="content">
				<p>Stay organized with quick, online access to the information you need to finish projects on time.</p>
