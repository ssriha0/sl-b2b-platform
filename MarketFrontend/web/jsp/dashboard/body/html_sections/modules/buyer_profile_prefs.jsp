...
<div class="leftTileItem" id="dbTile_profilePrefs">
    	...
    	<div class="titleBar">
      	<img src="${staticContextPath}/images/dashboard/hdrProfilePrefs.gif" width="101" height="23" align="left" class="titleImage" />
        <a href=""><img src="${staticContextPath}/images/dashboard/lnkMore.gif" width="41" height="23" border="0" align="right" /></a>
    	</div>
    </div>
    <div class="contentContainer">
    	<div class="content">
				<p>Set communications preferences, block user access and identify your favorite Providers.</p>
