								...
								<div id="homepageContent" style="padding-bottom: 70px;padding-top: 50px">
									<div class="colLeft711">
										<form action="${loginActionPath}" method="post" name="doLogin">
											<p>
												Your account currently under review by ServiceLive. Please have your account administrator login and submit some additional information. For more information contact ServiceLive administrator.											</p>
											<p>
											<div class="clearfix">
										</form>
									</div>
