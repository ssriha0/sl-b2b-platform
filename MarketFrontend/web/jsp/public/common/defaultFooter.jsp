	...
	<div id="footer" style="">
		<div class="footericons">
			...
			<c:set var="ref" scope="request" value="<%=request.getServerName()%>" />
             ...
             <img src="${staticContextPath}/images/common/comodo_secure_76x26_white.png" alt="Free SSL Certificate" width="76" height="26" style="border: 0px;border: 0px;position:relative;top:3px;">
             </a><br>
