...
<p><img src="${staticContextPath}/images/support/hdrTut_provSL.gif" alt="img" title="How Providers Use ServiceLive" height="14" width="222"/></p>
<p class="paddingBtm">Service providers use ServiceLive to connect with buyers who are looking for very specific skills. This tutorial will help you get familiar with the basic workflow within ServiceLive. More detailed instruction can be found in the <a href="${contextPath}/jsp/public/support/tutorial3.jsp">create a service profile tutorial.</a></p>
<div jsId="imageItemStore" dojoType="dojo.data.ItemFileReadStore" url="${contextPath}/jsp/public/support/tut3_images.jsp"></div>
