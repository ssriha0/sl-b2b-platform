...
<jsp:include page="/jsp/public/common/omitInclude.jsp" flush="true">
		 <jsp:param name="PageName" value="ProviderRegistration.insuranceAdd"/>
	</jsp:include>	
...
@import
	...
	<body class="tundra">
		...
		<jsp:include page="/jsp/public/common/omitInclude.jsp" flush="true">
			 <jsp:param name="PageName" value="Provider Registration - Add/Edit Insurance"/>
		</jsp:include>	
		...
		<div id="page_margins">
			<div id="page" class="clearfix">
				...
				<div id="mainTabContainer" dojoType="dijit.layout.TabContainer"
					style="height: 1200px; width: 711px; margin: 0;"
					class="provProfileTabs">
					<!-- TAB 4 -->
					<a dojoType="dijit.layout.LinkPane"
						href="html_sections/modules/tab_insurance_add_edit.jsp"><span
						class="tabIcon incomplete" id="tab4">Insurance</span> </a>
				</div>
				<!-- END TAB PANE -->
			</div>
			<!-- START FOOTER -->
