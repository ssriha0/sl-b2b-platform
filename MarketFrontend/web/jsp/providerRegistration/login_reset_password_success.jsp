...
<html>
	<head>
		<title>ServiceLive [Forget Password]</title>
...
<div id="wrap" class="container">
	...
	<div id="content" class="span-24 clearfix">		
		...
		<div class="span-16 first last">
			...
			<div class="content">
				...
				<fieldset>					
					<p class="paddingBtm">
							Thank you, We've sent your temporary password to the e-mail address we have on record for your account. If you don't receive the e-mail within 15 minutes, check your spam, filter.
						</p>
	...
	<jsp:include page="/jsp/public/common/omitInclude.jsp" flush="true">
		 <jsp:param name="PageName" value="login.reset.password.success"/>
	</jsp:include>
	</body>
</html>
