...
<c:set var="staticContextPath" scope="request" value="<%=request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+"/ServiceLiveWebUtil"%>" />
	...
	<jsp:include page="/jsp/public/common/omitInclude.jsp" flush="true">
		 <jsp:param name="PageName" value="FianaceManager.buyerFinantialProfile"/>
	</jsp:include>	
...
<jsp:include page="validationMessages.jsp" />
	...
	<div class="content">
		...
		<div class="grayModuleContent mainWellContent clearfix">
			<p>
				<fmt:message bundle="${serviceliveCopyBundle}" key="fm.financialprofile.buyeraccountsreceivable.msg"/>
			</p>
