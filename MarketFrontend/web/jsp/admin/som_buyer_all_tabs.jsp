...
@import
	...
	<body class="tundra">
		...
		<jsp:include page="/jsp/public/common/omitInclude.jsp" flush="true">
			 <jsp:param name="PageName" value="SOM - Buyer All Tabs"/>
		</jsp:include>	
			...
			<div id="page">
				...
				<div id="mainTabContainer" dojoType="dijit.layout.TabContainer"
					...
					<a dojoType="dijit.layout.LinkPane"
						href="html_sections/modules/tab_som_buyer_today.jsp"
						selected="true"><span class="tabNormal">Today (100)</span>
					</a>

					<!-- TAB 2 -->
					<a dojoType="dijit.layout.LinkPane" href=""><span
						class="tabNormal">Draft (100)</span>
					</a>
					<!-- TAB 3 -->
					<a dojoType="dijit.layout.LinkPane" href=""><span
						class="tabNormal">Posted (100)</span>
					</a>
					<!-- TAB 4 -->
					<a dojoType="dijit.layout.LinkPane" href=""><span
