...
@import
	...
	<body class="tundra">
		...
		<jsp:include page="/jsp/public/common/omitInclude.jsp" flush="true">
			 <jsp:param name="PageName" value="Admin - Ratings Buyer"/>
		</jsp:include>	
			...
			<div id="page">
				...
				<div id="headerSPReg">
					...
					<div id="pageHeader">
						<div>
							<img
								src="${staticContextPath}/images/sl_admin/hdr_mktplace_ratings_detail.gif"
								width="306" height="17" alt="Marketplace | Ratings"
				...
				<table cellspacing="0" cellpadding="0"
					...
					<tbody>
						<tr>
							...
							<td class="column4">
								<a class="sortGridColumnUp2" href="">Provider<br> Firm
									ID#</a>
							</td>
							<td class="column5">
								<a class="sortGridColumnUp2" href="">Buyer<br> Firm ID#</a>
							</td>
							<td class="column6">
