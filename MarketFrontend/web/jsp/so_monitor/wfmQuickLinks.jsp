...
<c:set var="fromWFM" value="cameFromWorkflowMonitor" />
...
<c:set var="EXPIRED" value="130"/>
	...
	<c:if test="${roleType == 1}">
		...
		<c:if test="${viewOrderPricing==true}">
			<a href="soDetailsController.action?${idParam}&defaultTab=Order History&displayTab=${theTab}&cameFromWorkflowMonitor=${fromWFM}" target="_top">
			 View Order History
			</a>
			|
			</c:if>
			
			<a href="soDetailsController.action?${idParam}&defaultTab=Support&displayTab=${theTab}&cameFromWorkflowMonitor=${fromWFM}" target="_top">
				ServiceLive Support
			</a>
		</c:if> 
		<c:if test="${rowsostatus == ACTIVE && !groupInd}">
			<a href="soDetailsController.action?soId=${soId}&defaultTab=Complete for Payment&displayTab=${theTab}&cameFromWorkflowMonitor=${fromWFM}" target="_top">
		...
		<c:if test="${rowsostatus == CLOSED && !groupInd}">
			<a href="soDetailsController.action?soId=${soId}&defaultTab=Completion Record&displayTab=${theTab}&cameFromWorkflowMonitor=${fromWFM}" target="_top">
		...
		<c:if test="${rowsostatus == COMPLETED && !groupInd}">
			...
			<a href="soDetailsController.action?${idParam}&defaultTab=Support&cameFromWorkflowMonitor=${fromWFM}" target="_top">
				ServiceLive Support
			</a>
		</c:if> 
		...
		<c:if test="${rowsostatus == RECEIVED}">
			...
			<c:if test="${viewOrderPricing==true}">
			<a href="soDetailsController.action?${idParam}&resId=${rowRoutedResourceId}&defaultTab=Order History&displayTab=${theTab}&cameFromWorkflowMonitor=${fromWFM}" target="_top">
				View Order History
			</a>
			</c:if>
			</c:if>
			...
			<c:if test="${not empty groupInd and not groupInd}">|</c:if>
				<a href="soDetailsController.action?${idParam}&resId=${rowRoutedResourceId}&defaultTab=Summary&displayTab=${theTab}&cameFromWorkflowMonitor=${fromWFM}" target="_top">
	...
	<c:if test="${(roleType==2)||(roleType==3)}">
		...
		<c:if test="${rowsostatus == COMPLETED && !groupInd}">
			<a href="soDetailsController.action?soId=${soId}&defaultTab=Close and Pay&displayTab=${theTab}&cameFromWorkflowMonitor=${fromWFM}" target="_top">
		...
		<c:if test="${rowsostatus == DRAFT}">
			<a href="soDetailsController.action?${idParam}&displayTab=${theTab}&cameFromWorkflowMonitor=${fromWFM}" target="_top">
				View Order Details
			</a>
			|
		...
		<c:if test="${rowsostatus == EXPIRED}">
			<c:if test="${not empty groupInd and not groupInd}">
			<a href="soWizardController.action?soId=${soId}&action=edit&tab=today&displayTab=${theTab}&cameFromWorkflowMonitor=${fromWFM}" target="_top">
				Edit Order
			</a>
			|
			<a href="soDetailsController.action?${idParam}&defaultTab=Order History&displayTab=${theTab}&cameFromWorkflowMonitor=${fromWFM}" target="_top">
		...
		<c:if test="${rowsostatus == POSTED}">
			<c:if test="${not empty groupInd and not groupInd}">
			<a href="soWizardController.action?soId=${soId}&action=edit&tab=posted&displayTab=${theTab}&cameFromWorkflowMonitor=${fromWFM}" target="_top">
				Edit Service Order
			</a>
			|
			<a href="soDetailsController.action?${idParam}&defaultTab=Order History&displayTab=${theTab}&cameFromWorkflowMonitor=${fromWFM}" target="_top">
			...
			<a href="soDetailsController.action?${idParam}&defaultTab=Response Status&displayTab=${theTab}&cameFromWorkflowMonitor=${fromWFM}" target="_top">
	...
	<c:if test="${roleType == 5}">
		<c:if test="${rowsostatus == ACCEPTED && !groupInd}">
			<a href="soDetailsController.action?soId=${soId}&defaultTab=Order History&displayTab=${theTab}&cameFromWorkflowMonitor=${fromWFM}" target="_top">
				View Order History
			</a>
			|
			<a href="soDetailsController.action?soId=${soId}&defaultTab=Support&displayTab=${theTab}&cameFromWorkflowMonitor=${fromWFM}" target="_top">
				ServiceLive Support
			</a>
		</c:if>
		<c:if test="${rowsostatus == ACTIVE && !groupInd}">
		...
		<!-- For Draft Support link is different because it can't navigate to SOD and hence redirected to generic support page -->
		<c:if test="${rowsostatus == DRAFT}">
			<a href="soDetailsController.action?soId=${soId}&displayTab=${theTab}&cameFromWorkflowMonitor=${fromWFM}" target="_top">
				View Order Details
			</a>
			|
			<a href="/MarketFrontend/jsp/public/support/support_faq.jsp" target="_top">
		...
		<c:if test="${rowsostatus == POSTED}">
			...
			<a href="soDetailsController.action?soId=${soId}&defaultTab=Response Status&displayTab=${theTab}&cameFromWorkflowMonitor=${fromWFM}" target="_top">
				View Provider Responses
			</a>
			|
			<a href="soDetailsController.action?soId=${soId}&defaultTab=Support&displayTab=${theTab}&cameFromWorkflowMonitor=${fromWFM}" target="_top">
