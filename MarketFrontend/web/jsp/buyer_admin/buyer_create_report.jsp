...
@import "${staticContextPath}/javascript/dojo/dijit/themes/tundra/tundra_rtl.css";
	...
	<body class="tundra">
		...
		<jsp:include page="/jsp/public/common/omitInclude.jsp" flush="true">
			 <jsp:param name="PageName" value="BuyerAdmin.createReport"/>
		</jsp:include>	
		...
		<div id="page_margins">
			<div id="page">
				...
				<div id="header">
					...
					<div id="pageHeader">
						<div>
							<img src="${staticContextPath}/images/admin/hdr_reportsCreateNew.gif"
								title="Reports | Create New Report"
								alt="Reports | Create New Report" />
						</div>
					</div>
				</div>
				<!-- END HEADER -->
