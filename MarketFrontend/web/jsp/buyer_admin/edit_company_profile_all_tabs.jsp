...
@import "${staticContextPath}/javascript/dojo/dijit/themes/tundra/tundra_rtl.css";
	...
	<body class="tundra">
		...
		<jsp:include page="/jsp/public/common/omitInclude.jsp" flush="true">
			 <jsp:param name="PageName" value="BuyerAdmin.editCompanyProfile"/>
		</jsp:include>	
		...
		<div id="page_margins">
			<div id="page">
				...
				<div id="header">
					...
					<div id="pageHeader">
						<div>
							<img src="${staticContextPath}/images/admin/hdr_editCompanyProfile.gif"
								title="Edit Company Profile" alt="Edit Company Profile" />
						</div>
					</div>
				</div>
				<!-- END HEADER -->
				...
				<div id="mainTabContainer" dojoType="dijit.layout.TabContainer"
					...
					<a class="" dojoType="dijit.layout.LinkPane"
						href="html_sections/modules/tab_business_info.html"
						selected="true">Business Information</a>
					<!-- TAB 2 -->
					<a class="tab2" dojoType="dijit.layout.LinkPane"
						href="html_sections/modules/tab_biz_logos.html">Business
						Logos</a>
				</div>
				<!-- END TAB PANE -->
