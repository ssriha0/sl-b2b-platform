...
@import "${staticContextPath}/javascript/dojo/dijit/themes/tundra/tundra_rtl.css";
	...
	<body class="tundra">
		...
		<jsp:include page="/jsp/public/common/omitInclude.jsp" flush="true">
			 <jsp:param name="PageName" value="Buyer Admin - Edit"/>
		</jsp:include>	
		...
		<div id="page_margins">
			<div id="page">
				...
				<div id="header">
					...
					<div id="pageHeader">
						<div>
							<img src="${staticContextPath}/images/admin/hdr_manageUsersEditUser.gif"
								alt="Manage Users | Edit User"
				...
				<div class="colRight255 clearfix">
					<!-- #INCLUDE file="html_sections/modules/buyer_profile_status_edit.jsp" -->
				</div>
				...
				<div id="mainTabContainer" dojoType="dijit.layout.TabContainer"
					...
					<a class="" dojoType="dijit.layout.LinkPane"
						href="html_sections/modules/tab_gen_info_edit.jsp" selected="true"><span
						class="tabIcon complete">General<br>Information</span> </a>
