...
public class BaseStrutsTestCaseOld<T> extends TestCase {
    private static final Logger logger = Logger.getLogger(BaseStrutsTestCaseOld.class.getName());
	...
	protected void setUp() throws Exception {
		String[] config = new String[] { "/resources/spring/applicationContext.xml" };
