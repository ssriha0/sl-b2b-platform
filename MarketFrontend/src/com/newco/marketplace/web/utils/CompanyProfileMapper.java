...
public class CompanyProfileMapper extends ObjectMapper{
	
	
	public CompanyProfileVO convertDTOtoVO(Object objectDto, Object objectVO) {
		CompanyProfileDto companyProfileDto = (CompanyProfileDto) objectDto;
		CompanyProfileVO companyProfileVO = (CompanyProfileVO) objectVO;
	 ...
	 */
	public CompanyProfileDto convertVOtoDTO(Object objectVO, Object objectDto) {
		CompanyProfileVO companyProfileVO = (CompanyProfileVO) objectVO;
		CompanyProfileDto companyProfileDto = (CompanyProfileDto) objectDto;
		if (companyProfileVO != null && companyProfileDto!= null) {
