...
public class CompleteProfileAction extends SLBaseAction implements SessionAware,
		ServletRequestAware {
	...
	public CompleteProfileAction(
			...
			ResourceSkillAssignDto skillAssignDto,
	...
	public String doLoad() throws Exception {
		try {
			...
			resourceId = ActionContext.getContext().getSession().get(
					"resourceId")
					+ "";
			if (vendorId != null) {
		...
		// Select Provider Networks Panel
		createCommonServiceOrderCriteria();		
		Integer providerId = get_commonCriteria().getVendBuyerResId();
		setAttribute("spnList", spnDelegate.getProviderProfileBuyers(providerId));
