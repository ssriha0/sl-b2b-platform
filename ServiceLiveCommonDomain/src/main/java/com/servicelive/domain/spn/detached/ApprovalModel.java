...
public class ApprovalModel implements Serializable
{
	...
	//Add new list attribute to hold the selected primary industry criteria
	private List<Integer> selectedPrimaryIndustry = new ArrayList<Integer>();
	private Boolean isPrimaryIndustryEnabled;
	...
	//R10.3SL-19812 Introduce Primary Industry criteria for Campaign
	/**
	 * @return the selectedPrimaryIndustry
	 */
	public List<Integer> getSelectedPrimaryIndustry() {
		return selectedPrimaryIndustry;
	}
	/**
	 * @param selectedPrimaryIndustry the selectedPrimaryIndustry to set
	 */
	public void setSelectedPrimaryIndustry(List<Integer> selectedPrimaryIndustry) {
		this.selectedPrimaryIndustry = selectedPrimaryIndustry;
	}
	/**
	 * @return the isPrimaryIndustryEnabled
	 */
	public Boolean getIsPrimaryIndustryEnabled() {
		return isPrimaryIndustryEnabled;
	}
	/**
	 * @param isPrimaryIndustryEnabled the isPrimaryIndustryEnabled to set
	 */
	public void setIsPrimaryIndustryEnabled(Boolean isPrimaryIndustryEnabled) {
		this.isPrimaryIndustryEnabled = isPrimaryIndustryEnabled;
	}
