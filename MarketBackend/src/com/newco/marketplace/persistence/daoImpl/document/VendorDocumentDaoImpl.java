...
public class VendorDocumentDaoImpl extends ABaseImplDao implements IDocumentDao{
	
	private static final Logger logger = Logger.getLogger(VendorDocumentDaoImpl.class.getName());
	...
	public DocumentVO retrieveBuyerDocumentByDocumentId(Integer documentId) throws DataServiceException {
		...
		try {
        	...
        	logger.info("[VendorDocumentDaoImpl.retrieveBuyerDocumentByDocumentId - Exception] "
                    + ex);
	...
	public ProcessResponse uploadDocument(DocumentVO documentVO) throws DataServiceException {
		...
		try {
			...
			throw new DataServiceException("General Exception @VendorDocumentDaoImpl.uploadDocument() due to " + exception.getMessage());
		}
		return pr;
	}
	...
	public void removeDocument(Integer documentId) throws DataServiceException {
		...
		try {		
			...
			logger.error("Exception: " + exception);
			throw new DataServiceException("General Exception @VendorDocumentDaoImpl.removeDocument() due to " + exception.getMessage());
		}
	}
	...
	public DocumentVO retrieveDocumentByDocumentId(Integer documentId) throws DataServiceException {		
		...
		try {
			inDocumentVO  = (DocumentVO) getSqlMapClient().queryForObject("document.query_by_document_id",documentId);
			inDocumentVO = documentService.retrieveDocumentFromDBOrFS(inDocumentVO);
		} catch(SQLException exception){
			logger.error("Exception: " + exception);
			throw new DataServiceException("General Exception @VendorDocumentDaoImpl.retrieveDocumentByDocumentId() due to " + exception.getMessage());
		} catch(Exception a_Ex) {
			logger.error("Exception: " + a_Ex);
			throw new DataServiceException("General Exception @VendorDocumentDaoImpl.retrieveDocumentByDocumentId() due to " + a_Ex.getMessage());
		}
		return inDocumentVO;
	}
	...
	public DocumentVO updateDocumentByDocumentId(DocumentVO inDocumentVO) throws DBException{
		...
		{
			logger.error("Exception: " + a_Ex);
			throw new DBException("General Exception @VendorDocumentDaoImpl.updateDocumentByDocumentId() due to " + a_Ex.getMessage());
		}
		return inDocumentVO;
	}
	...
	public DocumentVO retrieveDocumentMetaDataByDocumentId(DocumentVO inDocumentVO) throws DataServiceException {
		...
		try {
			...
			logger.error("Exception: " + exception);
			throw new DataServiceException("General Exception @VendorDocumentDaoImpl.selectMetadatByDocId() due to " + exception.getMessage());
		} catch(Exception a_Ex) {
			logger.error("Exception: " + a_Ex);
			throw new DataServiceException("General Exception @VendorDocumentDaoImpl.selectMetadatByDocId() due to " + a_Ex.getMessage());
		}
		return documentVO;
	}
