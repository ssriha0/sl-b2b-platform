...
public class BuyerOutboundNotificationVO {
	...
	private CustomerInformationVO customerInfoVo;
	...
	public CustomerInformationVO getCustomerInfoVo() {
		return customerInfoVo;
	}

	public void setCustomerInfoVo(CustomerInformationVO customerInfoVo) {
	...
	public void setServiceOrderScheduleFromDate(Date serviceOrderScheduleFromDate) {
	...
	public void setServiceOrderRescheduleToDate(Date serviceOrderRescheduleToDate) {
	...
	public void setServiceOrderRescheduleToTime(String serviceOrderRescheduleToTime) {
