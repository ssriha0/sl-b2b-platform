...
public class SimpleRestClient {
	...
	public HomeServiceResponseVO postMethod(String request, Map<String, String> headers) throws Exception{
    	 ...
    	 //commented for TLSv1 disabled in home services side.Enabled TLSv1.2
         ...
         try {
             ...
             //setting timeout
             httpURLConnection.setConnectTimeout(MPConstants.API_TIME_OUT);
        	...
        	LOGGER.error("IO Exception occured in postMethod for Tokenize HS():"+e);
            e.printStackTrace();
            throw new Exception("IO Exception occured in postMethod for Tokenize HS()");
		} 
        catch (Exception e) {
        	LOGGER.error("Exception occured in postMethod for Tokenize HS():"+e);
			e.printStackTrace();
			throw new Exception("Exception occured in postMethod for Tokenize HS()");
		}
