 ...
 *
 */
package com.newco.marketplace.api.utils.mappers.so.v1_5;
 ...
 * @version 1.3
 */
public class SORetrieveMapperV1_5{
private Logger logger = Logger.getLogger(SORetrieveMapperV1_5.class);
	...
	private void mapServiceOrderSchedule(ServiceOrder serviceOrder,
		...
		try {
			...
			if (null != serviceOrder.getRescheduleServiceDate1()) {
				...
				reschedule
						.setRescheduleServiceDateTime1(CommonUtility.sdfToDate
			...
			if (null != serviceOrder.getRescheduleServiceDate2()) {
				...
				reschedule
						.setRescheduleServiceDateTime2(CommonUtility.sdfToDate
