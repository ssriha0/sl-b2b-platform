...
package com.newco.marketplace.api.server.v1_6;
...
import com.newco.marketplace.api.services.so.v1_6.SORetrieveService;
...
public class SORequestProcessor extends com.newco.marketplace.api.server.v1_4.SORequestProcessor{
	...
	protected SORetrieveService retrieveService_v1_6;
	...
	String buyerId) {
		...
		String responseXML = retrieveService_v1_6.doSubmit(apiVO);
		return Response.ok(responseXML).build();

	}

	public SORetrieveService getRetrieveService_v1_6() {
		return retrieveService_v1_6;
	}

	public void setRetrieveService_v1_6(SORetrieveService retrieveService_v1_6) {
		this.retrieveService_v1_6 = retrieveService_v1_6;
	}
