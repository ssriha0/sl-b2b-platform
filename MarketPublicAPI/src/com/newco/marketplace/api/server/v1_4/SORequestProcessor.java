...
package com.newco.marketplace.api.server.v1_4;
...
import com.newco.marketplace.api.services.so.v1_4.SORetrieveService;
...
@Path("v1.4")
public class SORequestProcessor extends com.newco.marketplace.api.server.v1_3.SORequestProcessor{
	...
	protected SORetrieveService retrieveService_v1_4;
	...
	String buyerId) {
		...
		String responseXML = retrieveService_v1_4.doSubmit(apiVO);
		return Response.ok(responseXML).build();

	}

	public SORetrieveService getretrieveService_v1_4() {
		return retrieveService_v1_4;
	}

	public void setretrieveService_v1_4(SORetrieveService retrieveService_v1_4) {
		this.retrieveService_v1_4 = retrieveService_v1_4;
	}
