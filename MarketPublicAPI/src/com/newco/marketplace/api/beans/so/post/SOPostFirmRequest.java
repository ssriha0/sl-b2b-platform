...
public class SOPostFirmRequest implements IAPIRequest{
	...
	public FirmList getFirmIds() {
		return firmIds;
	}

	public void setFirmIds(FirmList firmIds) {
