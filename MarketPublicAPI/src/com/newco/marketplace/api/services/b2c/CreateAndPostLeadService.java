 ...
 * 
 */
@Namespace("http://www.servicelive.com/namespaces/createAndPostLead")
@APIRequestClass(CreateAndPostLeadRequest.class)
@APIResponseClass(CreateAndPostLeadResponse.class)
public class CreateAndPostLeadService extends BaseService {

	private static Logger logger = Logger.getLogger(CreateAndPostLeadService.class);
	...
	public CreateAndPostLeadService() {
		super();
	}
