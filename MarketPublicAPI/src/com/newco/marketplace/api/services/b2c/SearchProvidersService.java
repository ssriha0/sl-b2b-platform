...
@Namespace("http://www.servicelive.com/namespaces/searchProviders")
@APIRequestClass(SearchProvidersRequest.class)
@APIResponseClass(SearchProvidersResponse.class)
public class SearchProvidersService extends BaseService {

	private static Logger logger = Logger.getLogger(SearchProvidersService.class);
