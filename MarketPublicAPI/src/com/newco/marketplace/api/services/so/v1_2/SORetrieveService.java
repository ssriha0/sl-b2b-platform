 ...
 * -----------  --------- 	-----------  	---------
 * 10-Mar-2010	KMSTRSUP   Infosys				2.0
 * 
 * 
 */
		...
		try {
			...
			for (int index = 0; index < listSize; index++) {
				...
				if ((null != serviceOrder)
					...
					response = retrieveMapper.adaptRequest(serviceOrder,
							responseFilters);
				}
