 ...
 * 
 */
package com.newco.marketplace.api.services.so.v1_4;
...
import com.newco.marketplace.api.utils.mappers.so.v1_4.SORetrieveMapperV1_4;
...
public class SORetrieveService extends BaseService {
	...
	private SORetrieveMapperV1_4 retrieveMapper;

	
	public SORetrieveService() {
		super(null,
				PublicAPIConstant.SOGETRESPONSE_XSD_V1_4,
				PublicAPIConstant.SORESPONSE_NAMESPACE,
				PublicAPIConstant.SO_RESOURCES_SCHEMAS_V1_4,
				PublicAPIConstant.SO_RESOURCES_SCHEMAS_V1_4,
	...
	public SORetrieveMapperV1_4 getRetrieveMapper() {
		return retrieveMapper;
	}

	public void setRetrieveMapper(SORetrieveMapperV1_4 retrieveMapper) {
