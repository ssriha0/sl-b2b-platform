...
import com.newco.marketplace.api.utils.mappers.so.v1_3.SORetrieveMapperV1_3;
...
public class SORetrieveService extends BaseService {
	...
	private SORetrieveMapperV1_3 retrieveMapper;

	
	public SORetrieveService() {
		super(null,
				PublicAPIConstant.SOGETRESPONSE_XSD_V1_3,
	...
	public SORetrieveMapperV1_3 getRetrieveMapper() {
		return retrieveMapper;
	}

	public void setRetrieveMapper(SORetrieveMapperV1_3 retrieveMapper) {
