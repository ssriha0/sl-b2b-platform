...
public class Compare {
	...
	public static void main(String[] args) {
		...
		try {
			...
			dataCompare.newKey = keysMap.get(KeyRotationConstants.CCENKEY);
			dataCompare.oldKey = keysMap.get(KeyRotationConstants.CCENKEY_TEMP);
	...
	public void decryptAndLogData(String tableIndex) throws Exception {
		...
		if (KeyRotationConstants.BIT_128
				.equals(KeyRotationConstants.CHANGE_TO_BIT)) {
		...
		} else if (KeyRotationConstants.BIT_64
				.equals(KeyRotationConstants.CHANGE_TO_BIT)) {
		...
		if (KeyRotationConstants.BIT_128
				.equals(KeyRotationConstants.CHANGE_FROM_BIT)) {
			SecretKeyFactory factory = SecretKeyFactory
					.getInstance("PBKDF2WithHmacSHA1");
