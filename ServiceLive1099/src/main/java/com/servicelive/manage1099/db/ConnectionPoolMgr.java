...
public class ConnectionPoolMgr {
	...
	/**
	 * Constructs a ConnectionPoolMgr object with a timeout of 60 seconds.
	 * 
	 * @param dataSource
	 ...
	 */
	public ConnectionPoolMgr(ConnectionPoolDataSource dataSource,
			int maxConnections) {
