...
{   
	private Logger logger = Logger.getLogger(BoundedBufferedReader.class);
	public static final int DEFAULT_MAX_LINES = 1024;		//Max lines per file
...
if ((maxLines<=0) || (maxLineLen<=0)) throw new IllegalArgumentException("BoundedBufferedReader - maxLines and maxLineLen must be greater than 0");
	...
	public BoundedBufferedReader(InputStreamReader reader) 
	{
		...
		super(reader);
		logger.info("entered BoundedBufferedReader");
		readerMaxLines = DEFAULT_MAX_LINES;
		readerMaxLineLen = DEFAULT_MAX_LINE_LENGTH;
	}
	...
	public String readLine() throws IOException 
	{
		...
		logger.debug("entered readLine() of BoundedBufferedReader");
...
if (super.read() != LF) 
	...
	public String readLinePlusOne() throws IOException 
	{
		//Check readerMaxLines limit
		logger.debug("entered readLine() of BoundedBufferedReader");
