 ...
 */
public class ApplicationSecurePropertiesDao extends ABaseDao implements IApplicationPropertiesDao {
	...
	private void loadDataTable() throws DataAccessException {
		...
		List<ApplicationPropertiesVO> allData = (List<ApplicationPropertiesVO>) queryForList("application_secure_properties.query");
	...
	public ApplicationPropertiesVO queryToDatabase(String key) throws DataAccessException, DataNotFoundException {
		...
		return (ApplicationPropertiesVO) queryForObject("application_secure_propertiesbykey.query", key);
	}
