 ...
 *
 */
package com.servicelive.staging.dao;
...
public abstract class AbstractBaseDao implements BaseDao {
	 ...
	 */
	public Collection<?> findByProperty(String tableName ,String propertyName, Object value,int... rowStartIdxAndCount)  throws RuntimeException {
	 ...
	 * @throws RuntimeException
	 */
	public Collection<?> findAll(String tableName, int... rowStartIdxAndCount)
		throws RuntimeException {
	 ...
	 * @throws RuntimeException
	 */
	public Collection<?> findAllOrderByDesc(String tableName, String orderByProp, int... rowStartIdxAndCount)
		throws RuntimeException {
