...
/**
 * Interface for ShcOrderTransactionDAO.
 * 
 * @author MyEclipse Persistence Tools
 */

public interface IShcOrderTransactionDAO {
	/**
	 ...
	 * IShcOrderTransactionDAO.save(entity);
	 ...
	 * TransactionStatus txn = txManager
	 * 		.getTransaction(new DefaultTransactionDefinition());
	 * IShcOrderTransactionDAO.delete(entity);
	 * txManager.commit(txn);
	 * entity = null;
	 * </pre>
	 * 
	 ...
	 * TransactionStatus txn = txManager
	 * 		.getTransaction(new DefaultTransactionDefinition());
	 * entity = IShcOrderTransactionDAO.update(entity);
	 * txManager.commit(txn);
	 * </pre>
	 * 
	 * @see <a href =
