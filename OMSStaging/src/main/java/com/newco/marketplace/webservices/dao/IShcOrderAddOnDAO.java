...
/**
 * Interface for ShcOrderAddOnDAO.
 * 
 * @author MyEclipse Persistence Tools
 */

public interface IShcOrderAddOnDAO {
	/**
	 ...
	 * TransactionStatus txn = txManager
	 * 		.getTransaction(new DefaultTransactionDefinition());
	 * IShcOrderAddOnDAO.delete(entity);
	 * txManager.commit(txn);
	 * entity = null;
	 * </pre>
	 * 
	 ...
	 * TransactionStatus txn = txManager
	 * 		.getTransaction(new DefaultTransactionDefinition());
	 * entity = IShcOrderAddOnDAO.update(entity);
	 * txManager.commit(txn);
	 * </pre>
	 * 
	 * @see <a href =
	 ...
	 */
	public List<ShcOrderAddOn> findByProperty(String propertyName, Object value);
