...
@XStreamAlias("getReasonCodesResponse")
public class GetReasonCodesResponse implements IAPIResponse{
	...
	private ReasonCodeBean reasonCodeBean;
	
	public Results getResults() {
		return results;
	}
	
	public ReasonCodeBean getReasonCodeBean() {
		return reasonCodeBean;
	}

	public void setReasonCodeBean(ReasonCodeBean reasonCodeBean) {
		this.reasonCodeBean = reasonCodeBean;
	}
