package com.newco.marketplace.business.iBusiness.api.mobile;
...
public interface IAPISecurity {
	...
	public boolean isResourceValid(int resourceId) throws BusinessServiceException;
	public boolean isMobileTokenValid(String outhToken,String resourceId,Date serverDate) throws BusinessServiceException;
