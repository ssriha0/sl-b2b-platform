...
@XStreamAlias("getTabListResponse")
public class GetTabsResponse implements IAPIResponse {
	...
	@XStreamAlias("xmlns")   
	@XStreamAsAttribute()   
	private String namespace=PublicAPIConstant.TAB_REFRESH_NAMESPACE;
	...
	private TabCountList TabCount;

	public TabCountList getTabCount() {
		return TabCount;
	}

	public void setTabCount(TabCountList tabCount) {
		TabCount = tabCount;
	}
