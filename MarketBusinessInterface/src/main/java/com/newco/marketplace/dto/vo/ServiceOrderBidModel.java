...
public class ServiceOrderBidModel
{
	...
	private Integer bidderVendorId;
	

	public Integer getBidderVendorId() {
		return bidderVendorId;
	}

	public void setBidderVendorId(Integer bidderVendorId) {
		this.bidderVendorId = bidderVendorId;
	}
