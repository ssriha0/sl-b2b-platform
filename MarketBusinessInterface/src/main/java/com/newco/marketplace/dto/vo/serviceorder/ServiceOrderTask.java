...
public class ServiceOrderTask extends CommonVO implements Comparable<ServiceOrderTask> {
	...
	private List<SOTaskPriceHistoryVO> priceHistoryList = Collections.emptyList();
	
	private Integer taskSeqNum;
	private String taskStatus;
	
	private Integer manageScopeInd;
	...
	public List<SOTaskPriceHistoryVO> getPriceHistoryList() {
		return priceHistoryList;
	}

	public void setPriceHistoryList(List<SOTaskPriceHistoryVO> priceHistoryList) {
	...
	public int compareTo(ServiceOrderTask o) {
	...
	public Integer getManageScopeInd() {
		return manageScopeInd;
	}

	public void setManageScopeInd(Integer manageScopeInd) {
