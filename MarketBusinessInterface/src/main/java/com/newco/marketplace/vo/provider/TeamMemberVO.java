...
public class TeamMemberVO extends SerializableBaseVO
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3712677276895827909L;
    ...
    //Variables for Team Member Grid
    ...
    private List<TeamCredentialsVO> teamCredentials;
    
    //SL-19667 for background check recertification
    private Boolean backgroundCheckRecertify;
    
    public Boolean getBackgroundCheckRecertify() {
		return backgroundCheckRecertify;
	}
	public void setBackgroundCheckRecertify(Boolean backgroundCheckRecertify) {
		this.backgroundCheckRecertify = backgroundCheckRecertify;
	}
	...
	public List<TeamCredentialsVO> getTeamCredentials() {
		return teamCredentials;
	}
	public void setTeamCredentials(List<TeamCredentialsVO> teamCredentials) {
