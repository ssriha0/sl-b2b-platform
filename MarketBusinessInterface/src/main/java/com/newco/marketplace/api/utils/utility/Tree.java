 ...
 * a single rootElement which points to a List<TreeNode<T>> of children. There is
 ...
 * pre-order traversal. It has several methods to allow easy updation of TreeNodes
 * in the Tree.
 * 
