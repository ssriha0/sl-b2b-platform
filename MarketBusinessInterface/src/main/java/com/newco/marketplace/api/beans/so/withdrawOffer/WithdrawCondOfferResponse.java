package com.newco.marketplace.api.beans.so.withdrawOffer;
 ...
 *
 */
@XStreamAlias("withdrawOfferResponse")
public class WithdrawCondOfferResponse implements IAPIResponse{
