 ...
 *
 */
@XStreamAlias("providerSORescheduleRequest")
public class SOProviderRescheduleRequest extends UserIdentificationRequest {
	...
	@XStreamAlias("xmlns")   
	@XStreamAsAttribute()   
	private String namespace = PublicAPIConstant.SO_RESCHEDULE_RESPONSE_NAMESPACE;
