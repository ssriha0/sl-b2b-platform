//ss: required for provider_registration.jsp
	...
	function parseQuery ( query ) {
	   ...
	   return Params;
		...
		function checkPromoCode(){
			...
			if (howDidYouHear == 12 && promoCode == '')
			{
				alert('You must enter a Promotional Code if you heard about ServiceLive from a ServiceLive 3rd Party');
				return false;
			}
