    ...
    return function c(f, h, d) {
        function b(e, g) {
            if (!h[e]) {
                ...
                f[e][0].call(l.exports, function(a) {
                    var d = f[e][1][a];
                    return b(d ? d : a)
                }, l, l.exports, c, f, h, d)
            }
        ...
        for (var a = "function" == typeof require && require, g = 0; g < d.length; g++) b(d[g]);
        return b
    }({
        1: [function(c, f, h) {
            var d = c("xtend/mutable"),
                ...
                e = c("cookie-cutter"),
                u = c("ua-parser-js"),
                l = navigator.language.slice(-2) || navigator.userLanguage.slice(-2) || "us",
                m = {
                    ios: {
            ...
            c.prototype = {
                constructor: c,
                create: function() {
                    for (var d = this.getStoreLink(), e = this.options.price[this.type] + " - " + this.options.store[this.type], r, g = 0; g < this.iconRels.length; g++) {
                    ...
                    c.className = "smartbanner smartbanner-" +
                        this.type;
                    c.innerHTML = '<div class="smartbanner-container"><a href="javascript:void(0);closeSmartBanner();" class="smartbanner-close">&times;</a><span class="smartbanner-icon" style="background-image: url(' + r + ')"></span><div class="smartbanner-info"><div class="smartbanner-title">' + this.options.title + "</div><div>" + this.options.author + "</div><span style='padding-right:25px'>" + e + '</span></div><a href="' + d + '" class="smartbanner-button"><span class="smartbanner-button-text" onclick="closeSmartBanner();">' + this.options.button + "</span></a></div>";
        ...
        6: [function(c, f, h) {
            (function(d, b) {
                var a = {
                        extend: function(a,
                            b) {
                            for (var d in b) - 1 !== "browser cpu device engine os".indexOf(d) && 0 === b[d].length % 2 && (a[d] = b[d].concat(a[d]));
                            return a
                        },
                        has: function(a, b) {
                    ...
                    g = function() {
                        for (var a, d = 0, c, g, e, k, h, f, l = arguments; d < l.length && !h;) {
                            ...
                            if ("undefined" === typeof a)
                                for (e in a = {}, n) n.hasOwnProperty(e) && (k = n[e], "object" === typeof k ?
                                    a[k[0]] = b : a[k] = b);
                            for (c = g = 0; c < m.length && !h;)
                                if (h = m[c++].exec(this.getUA()))
                                    for (e = 0; e < n.length; e++) f = h[++g], k = n[e], "object" === typeof k && 0 < k.length ? 2 == k.length ? a[k[0]] = "function" == typeof k[1] ? k[1].call(this, f) : k[1] : 3 == k.length ? a[k[0]] = "function" !== typeof k[1] || k[1].exec && k[1].test ? f ? f.replace(k[1], k[2]) : b : f ? k[1].call(this, f, k[2]) : b : 4 == k.length && (a[k[0]] = f ? k[3].call(this, f.replace(k[1], k[2])) : b) : a[k] = f ? f : b;
                            d += 2
                        }
                        return a
                    },
                    ...
                    l = {
                        browser: [
                            ...
                            [/(kindle)\/([\w\.]+)/i,
                                /(lunascape|maxthon|netfront|jasmine|blazer)[\/\s]?([\w\.]+)*/i, /(avant\s|iemobile|slim|baidu)(?:browser)?[\/\s]?([\w\.]*)/i, /(?:ms|\()(ie)\s([\w\.]+)/i, /(rekonq)\/([\w\.]+)*/i, /(chromium|flock|rockmelt|midori|epiphany|silk|skyfire|ovibrowser|bolt|iron|vivaldi|iridium|phantomjs)\/([\w\.-]+)/i
                            ],
                            ["name", "version"],
                            ...
                            [/(swiftfox)/i, /(icedragon|iceweasel|camino|chimera|fennec|maemo\sbrowser|minimo|conkeror)[\/\s]?([\w\.\+]+)/i, /(firefox|seamonkey|k-meleon|icecat|iceape|firebird|phoenix)\/([\w\.-]+)/i, /(mozilla)\/([\w\.]+).+rv\:.+gecko\/\d+/i, /(polaris|lynx|dillo|icab|doris|amaya|w3m|netsurf|sleipnir)[\/\s]?([\w\.]+)/i, /(links)\s\(([\w\.]+)/i, /(gobrowser)\/?([\w\.]+)*/i, /(ice\s?browser)\/v?([\w\._]+)/i,
                                /(mosaic)[\/\s]([\w\.]+)/i
                            ],
                            ["name", "version"]
                        ],
                    ...
                    m = function(b, c) {
                        ...
                        var e =
                            b || (d && d.navigator && d.navigator.userAgent ? d.navigator.userAgent : ""),
                            f = c ? a.extend(l, c) : l;
                ...
                "undefined" !==
                typeof h ? ("undefined" !== typeof f && f.exports && (h = f.exports = m), h.UAParser = m) : d.UAParser = m;
