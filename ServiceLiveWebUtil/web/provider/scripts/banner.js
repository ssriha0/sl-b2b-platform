//Adding this js code to handle ie7 specific margin-left in static pages
...
function displayBanner(){
		   ...
		   var bannercookie = getBannerCookie('isDismissedBanner');
		     if(bannercookie==null){
			     //alert('cookie null,create cookie with no value.');
			     setBannerCookie('isDismissedBanner','No',null);
			    }
		  bannercookie = getBannerCookie('isDismissedBanner');
          ...
          var browserText = 'You are using an unsupported browser version and some features may not work correctly. Please use <b>Firefox 20.0.1</b>  or <b>Chrome 34.0</b> for the best experience.';
		   ...
		   //Based on browser version we have to show different divs for incompatible browsers.
			   ...
			   //Code to handle firefox compatibility
                        ...
                        if (fullVersion != ffSupportedVersion){ 
                        	//alert("not ff 20.0 displaying the banner");
		                       ...
		                       if(document.getElementById('bannerAdjustDiv')){
		                           document.getElementById('bannerAdjustDiv').style.marginTop ='30px';
		                        }
...
function removeBanner(){
		  if(document.getElementById('bannerAdjustDiv')){
              document.getElementById('bannerAdjustDiv').style.marginTop ='0px';
           }
          else if(document.getElementById('header')){
