...
public class NPSCancelAuditMapInputAction extends AbstractMapforceInputAction {

	public NPSCancelAuditMapInputAction() { super(); }
	public NPSCancelAuditMapInputAction(ConfigTree config) throws ConfigurationException { super(config); }
