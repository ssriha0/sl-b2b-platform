...
public class ReqResValidator {
	...
	public boolean validateXML(String strRequestXML, String schemaLocation, String xsd) {
		...
		try {
			...
			logger.info("xmlFile:::"+xmlFile.getSystemId());
			...
			logger.error("Reason Details: " + e.getMessage());
			//SL-20098: Removing the e.getMessage() from the response xml
			errorString = CommonUtility.getMessage(PublicAPIConstant.INVALIDXML_ERROR_CODE);
