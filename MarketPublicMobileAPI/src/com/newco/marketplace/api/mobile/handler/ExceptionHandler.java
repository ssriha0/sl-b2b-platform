package com.newco.marketplace.api.mobile.handler;
...
import com.newco.marketplace.api.exceptions.MobileAPIException;
...
public class ExceptionHandler implements ExceptionMapper {
	...
	public Response toResponse(Throwable exception) {
		...
		MobileAPIException mobileAPIException = new MobileAPIException(
