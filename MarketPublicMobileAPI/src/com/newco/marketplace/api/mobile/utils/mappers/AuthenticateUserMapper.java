...
import com.newco.marketplace.api.mobile.beans.authenticateUser.LocationDetail;
import com.newco.marketplace.api.mobile.beans.authenticateUser.Locations;
...
public class AuthenticateUserMapper {
	...
	public UserProfileData populateDataForUser(LoginProviderResponse loginProviderResponse, UserProfileData userProfileData) throws Exception {
		
		if(userProfileData.getRoleId() == PublicMobileAPIConstant.API_PROVIDER_ROLE_ID){
...
public UserProfileData populateDataForUser(com.newco.marketplace.api.mobile.beans.authenticateUser.v2_0.LoginProviderResponse
		loginProviderResponse, UserProfileData userProfileData) throws Exception {
...
public com.newco.marketplace.api.mobile.beans.authenticateUser.v2_0.UserProviderDetails 
	populateUserResponseV2(UserProfileData userProfileData){
	com.newco.marketplace.api.mobile.beans.authenticateUser.v2_0.UserProviderDetails  userDetails = null;
	
	if(null != userProfileData ){
		userDetails = new com.newco.marketplace.api.mobile.beans.authenticateUser.v2_0.UserProviderDetails ();
		...
		if(null != userProfileData.getListOflocations() && userProfileData.getListOflocations().size() > 0){
				List<com.newco.marketplace.api.mobile.beans.authenticateUser.v2_0.LocationDetail> 
					locationList = new ArrayList<com.newco.marketplace.api.mobile.beans.authenticateUser.v2_0.LocationDetail>();
				com.newco.marketplace.api.mobile.beans.authenticateUser.v2_0.Locations locations = 
					new com.newco.marketplace.api.mobile.beans.authenticateUser.v2_0.Locations();
			for(LocationResponseData locationData:userProfileData.getListOflocations()){
				com.newco.marketplace.api.mobile.beans.authenticateUser.v2_0.LocationDetail locationDetails = 
					new com.newco.marketplace.api.mobile.beans.authenticateUser.v2_0.LocationDetail();
