...
*
*/
@XSD(name="mobileSOAdvanceSearchResponse.xsd", path="/resources/schemas/mobile/v3_0/")
@XmlRootElement(name = "mobileSOAdvanceSearchResponse")
@XStreamAlias("mobileSOAdvanceSearchResponse")
@XmlAccessorType(XmlAccessType.FIELD)
public class MobileSOAdvanceSearchResponse implements IAPIResponse {
