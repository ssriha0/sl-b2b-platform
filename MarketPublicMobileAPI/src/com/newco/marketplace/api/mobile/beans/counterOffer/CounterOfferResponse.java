 ...
 * This is a bean class for storing response information for the CounterOffer
 */
@XSD(name = "counterOfferResponse.xsd", path = "/resources/schemas/mobile/v3_0/")
@XmlRootElement(name = "counterOfferResponse")
