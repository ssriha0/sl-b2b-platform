package com.newco.marketplace.api.mobile.constants;
 ...
 * @version 1.0
 */
public class PublicMobileAPIConstant {
	...
	public static final List<Integer> PAGE_SIZE_SET_VALUES = Arrays.asList(
			PublicMobileAPIConstant.PAGE_SIZE_SET_10,
			PublicMobileAPIConstant.PAGE_SIZE_SET_20,
			PublicMobileAPIConstant.PAGE_SIZE_SET_50,
			PublicMobileAPIConstant.PAGE_SIZE_SET_100,
			PublicMobileAPIConstant.PAGE_SIZE_SET_200,
			PublicMobileAPIConstant.PAGE_SIZE_SET_250);
	//R14.0 Reject SO API
