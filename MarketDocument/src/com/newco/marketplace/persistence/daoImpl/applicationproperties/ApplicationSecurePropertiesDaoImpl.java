...
public class ApplicationSecurePropertiesDaoImpl extends ABaseImplDao implements IApplicationPropertiesDao{
	...
	private void loadDataTable() throws DataAccessException {
		List<ApplicationPropertiesVO> allData = queryForList("application_secure_properties.query", new ApplicationPropertiesVO());
	...
	public synchronized String queryByKey(String key)throws DataAccessException, DataNotFoundException {
		return (String)queryForObject("application_secure_propertiesbykey.query", key);
    }
}