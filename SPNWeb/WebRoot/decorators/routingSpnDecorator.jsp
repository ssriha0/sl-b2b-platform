...
<html>
	<head>
		...
		<%-- 
		<link rel="stylesheet" type="text/css" href="${staticContextPath}/css/jqueryui/ui.core.css" />
		<link rel="stylesheet" type="text/css" href="${staticContextPath}/css/jqueryui/ui.theme.css" />
		<link rel="stylesheet" type="text/css" href="${staticContextPath}/css/jqueryui/ui.spinner.css" />
		--%>
		...
		<%-- 
		<script type="text/javascript" src="${staticContextPath}/javascript/jquery/jqueryui/ui.core.js"></script>			
		<script type="text/javascript" src="${staticContextPath}/javascript/jquery/jqueryui/ui.spinner.min.js"></script>
		--%>
