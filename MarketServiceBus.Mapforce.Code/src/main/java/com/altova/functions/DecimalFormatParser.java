...
public class DecimalFormatParser {
	...
	protected boolean pattern ( StringBuffer sExpr )
	{
		if ( sExpr.length() == 0 )
			return false;
	...
	protected boolean subPattern ( StringBuffer sExpr )
	{
		...
		if( sExpr.charAt(0) == mDecimalFormat.GetDecimalSeparator() )
		{
	...
	public String formatNumber ( BigDecimal nNumber )
	{
		...
		{
			if( sNumber.toString().equals( "0" ) ) //special case for 0
				iDecimalPos = 0;
			else
