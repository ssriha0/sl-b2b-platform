...
public class TextNodeList implements ITextNodeList {
	...
	public TextNodeListIterator iterator() {
		return m_List == null ?
				new EmptyTextNodeListIterator() : new TextNodeListIterator(m_List.iterator());
	}
	...
	public ITextNode getFirstNodeByName(String name) {
		...
		return children.size() == 0 ? NullTextNode.getInstance() : children.getAt(0);
	}
	...
	public ITextNode getLastNodeByName(String name) {
		...
		TextNodeList children = filterByName(name);
		return children.size() == 0 ? NullTextNode.getInstance() : children.getAt(children.size()-1);
	}
