...
public class SLPartsOrderFileProcessor extends BaseFileUtil{
	...
	private static final String MAIL_BODY = "Process Name: SL Parts Order File Processor\n" +
											...
											"Exception Details: ";
	private static final String SL_ENCRYPT_PARTS_FILE_SCRIPT_PATH =  PropertiesUtils.getPropertyValue(Constants.AppPropConstants.SL_ENCRYPT_PARTS_FILE_SCRIPT_PATH);
	...
	public void generateFile() {
		try
		{
	        ...
	        if(slPartsOrderList!=null && slPartsOrderList.size()>0)
	        {
				...
				Runtime.getRuntime().exec(SL_ENCRYPT_PARTS_FILE_SCRIPT_PATH + " " + fileNameWithDir + " " + (SL_PARTS_ORDER_FILE_ARCHIVE_DIRECTORY + fileName));
