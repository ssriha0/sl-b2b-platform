 ...
 <table class="passwordReset" cellpadding="0" cellspacing="0">
    ...
    <div class="clearfix">
			 <div class="formNavButtons padd">
					<input type="submit" class="button action" value="Add A New User" onClick="javascript:window.location.href=('<s:url action="serviceProAllTab" method="doNew" includeParams="none" />');" />
			 </div>			
	</div>
   </div>
	</div>
