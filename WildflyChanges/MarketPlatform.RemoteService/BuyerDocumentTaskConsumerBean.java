 ...
 */
public class BuyerDocumentTaskConsumerBean extends AbstractMessageDrivenBean implements MessageListener {

    private static final long serialVersionUID = 1;
    private static final String BEAN_FACTORY_NAME = "MarketPlatform.NotificationMDB";

    private static final Logger logger = Logger.getLogger(BuyerDocumentTaskConsumerBean.class);
    ...
    protected void onEjbCreate() {
    	...
    	marketPlatformBuyerBO = (IMarketPlatformBuyerBO)this.getBeanFactory().getBean("mktPlatformBuyerBO");
    }
    ...
    public void onMessage(Message message) {
		logger.info("BuyerDocumentTaskConsumer Service MDB received a message");
		ServiceOrderBuyerDocumentsVO buyerDocumentVO = extractNotificationTask(message);
    ...
    private ServiceOrderBuyerDocumentsVO extractNotificationTask(Message message) throws EJBException {
    	try {
	    	Object obj = null;
	    	if (message instanceof ObjectMessage){
	            ...
	            String errMsg = "BuyerDocumentTaskConsumerBean expects ObjectMessage or BytesMessage instance but got - " + message.getClass().getName();
	            logger.error(errMsg);
