...
public interface ServiceOrderSEI {
    ...
    /**
     * This operation has been added to getServiceOrderUsingCustomReference
     * using WSDL bindings.
     * 
     * 
     */
    @WebMethod(operationName = "getSOStatus")
    @WebResult(name = "GetSOStatusResponse")
    public GetSOStatusResponse getSOStatus(GetSOStatusRequest getSOStatusRequest);
