...
/**
 * Interface for UserProfileRoleDAO.
 * 
 * @author MyEclipse Persistence Tools
 */

public interface IUserProfileRoleDAO {
	/**
	 ...
	 * IUserProfileRoleDAO.save(entity);
	 ...
	 * TransactionStatus txn = txManager
	 * 		.getTransaction(new DefaultTransactionDefinition());
	 * IUserProfileRoleDAO.delete(entity);
	 * txManager.commit(txn);
	 * entity = null;
	 * </pre>
	 * 
	 ...
	 * TransactionStatus txn = txManager
	 * 		.getTransaction(new DefaultTransactionDefinition());
	 * entity = IUserProfileRoleDAO.update(entity);
	 * txManager.commit(txn);
	 * </pre>
	 * 
	 * @see <a href =
