 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected java.lang.String localOfferURL ;
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String getOfferURL(){
                               return localOfferURL;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param OfferURL
                               */
                               public void setOfferURL(java.lang.String param){
                            
                                            this.localOfferURL=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       ClickThru.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"offerName", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"offerName");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("offerName");
                                    }
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"offerURL", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"offerURL");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("offerURL");
                                    }
                                

                                          if (localOfferURL==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localOfferURL);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("urn:ws57.responsys",
                                         ...
                                         elementList.add(localOfferName==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localOfferName));
                                    
                                      elementList.add(new javax.xml.namespace.QName("urn:ws57.responsys",
                                                                      "offerURL"));
                                 
                                         elementList.add(localOfferURL==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localOfferURL));
    ...
    public static class Factory{
        ...
        */
        public static ClickThru parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ClickThru object =
                new ClickThru();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ClickThru".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ClickThru)responsys.ws57.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:ws57.responsys","offerName").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:ws57.responsys","offerURL").equals(reader.getName())){
