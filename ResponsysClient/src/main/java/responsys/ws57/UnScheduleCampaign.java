 ...
 */
            ...
            /**
            *  UnScheduleCampaign bean class
            */
        
        public  class UnScheduleCampaign
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       UnScheduleCampaign.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":unScheduleCampaign",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "unScheduleCampaign",
                                        ...
                                        xmlWriter.writeStartElement("scheduleDate");
                                          ...
                                          if (localScheduleDate==null){
                                              // write the nil attribute
                                                     ...
                                                     throw new org.apache.axis2.databinding.ADBException("scheduleDate cannot be null!!");
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("urn:ws57.responsys",
                                        ...
                                        if (localScheduleDate != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localScheduleDate));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("scheduleDate cannot be null!!");
                                        }
    ...
    public static class Factory{
        ...
        */
        public static UnScheduleCampaign parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UnScheduleCampaign object =
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"unScheduleCampaign".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UnScheduleCampaign)responsys.ws57.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
