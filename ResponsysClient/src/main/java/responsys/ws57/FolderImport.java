 ...
 */
            ...
            /**
            *  FolderImport bean class
            */
        
        public  class FolderImport extends responsys.ws57.IntermediateResult
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       FolderImport.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("urn:ws57.responsys","FolderImport"));
    ...
    public static class Factory{
        ...
        */
        public static FolderImport parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FolderImport object =
                new FolderImport();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"FolderImport".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (FolderImport)responsys.ws57.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
