 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for IsUpperIndex
                        */

                        
                                    protected boolean localIsUpperIndex ;
                           ...
                           * @return boolean
                           */
                           public  boolean getIsUpperIndex(){
                               return localIsUpperIndex;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param IsUpperIndex
                               */
                               public void setIsUpperIndex(boolean param){
                            
                                            this.localIsUpperIndex=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       AddIndex.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                                   ...
                                   for (int i = 0;i < localFieldNames.length;i++){
                                            ...
                                            if (localFieldNames[i] != null){
                                                ...
                                                xmlWriter.writeEndElement();
                                                           ...
                                                           throw new org.apache.axis2.databinding.ADBException("fieldNames cannot be null!!");
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"indexName", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"indexName");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("indexName");
                                    }
                                          ...
                                          if (localIndexName==null){
                                              // write the nil attribute
                                                     ...
                                                     throw new org.apache.axis2.databinding.ADBException("indexName cannot be null!!");
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"isUpperIndex", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"isUpperIndex");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("isUpperIndex");
                                    }
                                
                                               if (false) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("isUpperIndex cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIsUpperIndex));
                                               }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("urn:ws57.responsys",
                                        ...
                                        if (localTableName != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localTableName));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("tableName cannot be null!!");
                                        }
                            ...
                            if (localFieldNames!=null){
                                  for (int i = 0;i < localFieldNames.length;i++){
                                    ...
                                    throw new org.apache.axis2.databinding.ADBException("fieldNames cannot be null!!");
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("urn:ws57.responsys",
                                        ...
                                        if (localIndexName != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIndexName));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("indexName cannot be null!!");
                                        }
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIsUpperIndex));
    ...
    public static class Factory{
        ...
        */
        public static AddIndex parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddIndex object =
                new AddIndex();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addIndex".equals(type)){
                                ...
                                return (AddIndex)responsys.ws57.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:ws57.responsys","fieldNames").equals(reader.getName())){
                                    ...
                                    list3.add(reader.getElementText());
                                            ...
                                            while(!loopDone3){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("urn:ws57.responsys","fieldNames").equals(reader.getName())){
                                                         list3.add(reader.getElementText());
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:ws57.responsys","indexName").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:ws57.responsys","isUpperIndex").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setIsUpperIndex(
